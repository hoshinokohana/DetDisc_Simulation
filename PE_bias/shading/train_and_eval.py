...
def main():
    ...
    parser.add_argument('--contrast1', type=float, default=0.1, help='Contrast adjustment for the first digit')
    parser.add_argument('--contrast2', type=float, default=0.9, help='Contrast adjustment for the second digit')
